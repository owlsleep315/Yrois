...
function getTrainAdjustment(trainNo, record) {
  void trainNo;
  void record;
  // TODO: 열차번호, 시간대, 승하차 인원/유형 등을 기준으로
